...
//! array indices for conserved: density, momemtum, total energy. ADDED PSI SCALAR FIELD
enum ConsIndex {IDN=0, IM1=1, IM2=2, IM3=3, IEN=4, IPSIC=5};
//! array indices for face-centered field
enum MagneticIndex {IB1=0, IB2=1, IB3=2};

//! array indices for 1D primitives: velocity, transverse components of field. ADDED PSI SCALAR FIELD
enum PrimIndex {IVX=1, IVY=2, IVZ=3, IPR=4, IBY=(NHYDRO-1), IBZ=((NHYDRO)), IPSIW=(NHYDRO+1)};
